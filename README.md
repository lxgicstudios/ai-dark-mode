...
<p align="center">
  ...
  <a href="https://github.com/lxgicstudios/ai-dark-mode/actions">
...
[![GitHub stars](https://img.shields.io/github/stars/LXGIC-Studios/ai-dark-mode?style=for-the-badge&logo=github&label=stars)](https://github.com/lxgicstudios/ai-dark-mode)
[![License: MIT](https://img.shields.io/npm/l/ai-dark-mode.svg?style=for-the-badge&logo=mit&color=blue)](https://github.com/lxgicstudios/ai-dark-mode/blob/main/LICENSE)
...
```javascript
// Import the package
const dark-mode = require('ai-dark-mode');
...
```bash
git clone https://github.com/lxgicstudios/ai-dark-mode.git
cd ai-dark-mode
npm install
npm run dev
```
